...
    """
    ...
    xi1 = max(box1_x1,box2_x1) #2
    yi1 = max(box1_y1,box2_y1) #2
    xi2 = min(box1_x2,box2_x2) #4
    yi2 = min(box1_y2,box2_y2) #4
    inter_width = max(yi2-yi1,0) #2
    inter_height = max(xi2-xi1,0) #2
    inter_area = inter_width * inter_height
    ### END CODE HERE ###    

    # Calculate the Union area by using Formula: Union(A,B) = A + B - Inter(A,B)
    ### START CODE HERE ### (≈ 3 lines)
    box1_area = (box1_x2 - box1_x1) * (box1_y2 - box1_y1) #2 * 2
    box2_area = (box2_x2 - box2_x1) * (box2_y2 - box2_y1) # 2 *2
